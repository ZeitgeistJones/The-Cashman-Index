...
export const COLUMN_TIPS = {
  ...
  thrift:
    "Wins per $100M of opening-day payroll, divided by that year’s league mean, then averaged across seasons equally — a $300M year counts the same as a $60M year, not by dollars spent (1.0 ≈ league-average thrift)",
  draftVos:
